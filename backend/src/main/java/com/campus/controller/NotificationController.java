...
// import com.campus.dto.NotificationSendRequest; // 移除 DTO 导入
import com.campus.entity.Notification;
import com.campus.exception.CustomException;
import com.campus.exception.ResourceNotFoundException; // 导入
import com.campus.service.NotificationService;
import com.campus.utils.Result;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.security.core.Authentication; // 导入 Spring Security
import org.springframework.security.core.context.SecurityContextHolder; // 导入 Spring Security
import com.campus.entity.User; // 导入 User 实体
// import org.slf4j.Logger;
// import org.slf4j.LoggerFactory;
import org.springframework.web.bind.annotation.*;
// import org.springframework.security.core.Authentication; // 示例：导入Spring Security
// import org.springframework.security.core.context.SecurityContextHolder; // 示例：导入Spring Security
import com.fasterxml.jackson.databind.ObjectMapper; // 如果未导入，添加此行
...
public class NotificationController {
    ...
    public Result<List<Map<String, Object>>> getNoticeTypes() {
        try {
            // 调用 Service 层获取通知类型
            List<Map<String, Object>> noticeTypes = notificationService.getNoticeTypes();
            return Result.success("获取通知类型成功", noticeTypes);
        } catch (Exception e) {
            // 记录日志
            // logger.error("获取通知类型失败", e);
