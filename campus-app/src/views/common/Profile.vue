...
import {getCurrentUser, updateUserProfile, changePassword as changePasswordApi} from '@/api/user'; // 引入修改密码API
import {logout, userRole, userInfo, userAvatar, setUserInfo, setUserAvatar, token} from '@/utils/auth';
