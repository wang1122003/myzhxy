...
public enum Term {
    ...
    S2024_2025_1("2024-2025-1", "2024-2025学年第一学期", false), // 假设这是当前学期 -> 不再是当前
    S2024_2025_2("2024-2025-2", "2024-2025学年第二学期", true); // 设置为当前学期
    // --- 可根据需要添加更多学期 --- 

    private final String code; // 学期代码，例如 "2024-2025-2"
