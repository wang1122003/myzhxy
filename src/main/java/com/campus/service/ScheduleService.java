...
public interface ScheduleService extends IService<Schedule> {
    ...
    /**
     * 分页查询课表 (根据 Controller 和 Impl 需要添加)
     *
     * @param params 查询参数
     * @param page   页码
     * @param size   每页数量
    ...
    /**
     * 根据用户ID和学期信息获取详细课表列表 (包含关联名称)
     *
     * @param userId   用户ID
     * @param termInfo 学期代码
     * @return 包含详细信息的课表列表
     */
    List<Schedule> getStudentScheduleListWithDetails(Long userId, String termInfo);
}